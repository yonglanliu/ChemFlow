...
from chemflow.deep_learning.graphormer.inference.predictor import GraphormerPredictor
...
class GraphormerPredictCliTest(unittest.TestCase):
    def test_predict_graphormer_cli_parses_and_executes(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("chemflow.cli.predict.GraphormerPredictor") as mock_predictor_cls:
