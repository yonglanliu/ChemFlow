chemflow predict graphormer \
  ...
  --task-names LogD_prediction LogS_prediction "Log(MLM_Clint)_prediction" "Log(HLM_Clint)_prediction" "Log(Caco2_Papp)_prediction" "Log(Caco2_ER)_prediction" "Log(MPPB)_prediction" "Log(MBPB)_prediction" "Log(MGMB)_prediction" \
...
#   --calibration-pairs LogD:LogD_prediction LogS:LogS_prediction "Log(MLM_Clint)":"Log(MLM_Clint)_prediction" "Log(HLM_Clint)":"Log(HLM_Clint)_prediction" "Log(Caco2_Papp)":"Log(Caco2_Papp)_prediction" "Log(Caco2_ER)":"Log(Caco2_ER)_prediction" "Log(MPPB)":"Log(MPPB)_prediction" "Log(MBPB)":"Log(MBPB)_prediction" "Log(MGMB)":"Log(MGMB)_prediction"