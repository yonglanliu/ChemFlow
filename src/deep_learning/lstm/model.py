...
class SmilesLSTM(nn.Module):
    ...
    def get_config(self):
        return {
            ...
            "embedding_dim": self.token_encoder.embedding_dim,
            "hidden_dim": self.language_model.hidden_size,
            "num_layers": self.language_model.num_layers,
            "dropout": self.language_model.dropout if self.language_model.num_layers > 1 else 0.0,
        }
    @torch.no_grad()
    def generate(
        self,
