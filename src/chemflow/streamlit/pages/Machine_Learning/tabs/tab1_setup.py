...
def design():
    ...
    import chemflow.streamlit.pages.Machine_Learning.tabs.tab1_utils.model_selection as model_selection
    from chemflow.streamlit.utils.select_file import file_picker
    from chemflow.streamlit.pages.Machine_Learning.tabs.tab1_utils import featurization
    from chemflow.streamlit.pages.Machine_Learning.tabs.tab1_utils import data_split
