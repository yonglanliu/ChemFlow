...
from chemflow.machine_learning.data import dataset
...
from chemflow.deep_learning.graphormer.modules.graphormer_featurizer import (
    GraphormerFeaturizer,
)
from chemflow.deep_learning.graphormer.utils.data_collator import (
    graphormer_collate_fn,
)
from chemflow.deep_learning.utils import namespace_to_dict
...
class GraphormerInferenceDataset(Dataset):
    ...
    def __init__(
        ...
        self.smiles_list = [str(smiles).strip() for smiles in smiles_list]
        graph_features = []
